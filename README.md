...
[Chiklist Link](https://sam-auth-me.onrender.com)

## Project Summary

The Chiklist is a meetup.com clone with it's own special twist as a dedicated fan resource for Michael Chiklis. Users are encouraged to create their own accounts, groups, and events in order to connect with the greater Chiklis community.
...
![Grouplist Page](image-1.png)

### Eventlist

![Eventlist Page](image-2.png)

### Event Details

![Event Details Page](image-3.png)

### Group Details

![Group Details Page](image-4.png)

### Create Group

![Create Group Page](image-5.png)

### Create Event

![Create Event Page](image-6.png)
...
JWT_EXPIRES_IN=<expiration-in-seconds>
...
- Users able to join groups and events
- Setting up memberships and attendance
- Support for Venues/CRUD implementation
- AWS/S3 Bucket implementation for image hosting
- Personal group and event aggregation pages for management
